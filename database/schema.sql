CREATE DATABASE IF NOT EXISTS lautamgioi_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE lautamgioi_db;
...
CREATE TABLE bookings (
    ...
    table_id INT,
    special_notes TEXT,
    status ENUM('PENDING','CONFIRMED','SEATED','PAID','CANCELLED') NOT NULL DEFAULT 'PENDING',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
('Đồ uống', 'Trà, nước ép và đồ uống dùng kèm.');
...
(5, 'Trà Hoa Mộc', 'https://images.unsplash.com/photo-1544787219-7f47ccb76574?auto=format&fit=crop&w=900&q=80', 39000, 'Trà hoa thanh nhẹ dùng nóng hoặc lạnh.', 'AVAILABLE');
